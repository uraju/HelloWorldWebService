...
<UL>
<LI><A HREF="Input.jsp?method=2&methodName=helloName" TARGET="inputs">helloName(java.lang.String)</A></LI>
</UL>
<%
if (com.ibm.ccl.ws.jaxws.gstc.util.AsyncUtils.hasAsync(sampleHelloWorldPortProxyid.getClass())) {
%>
