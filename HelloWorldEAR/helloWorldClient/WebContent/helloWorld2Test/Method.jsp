...
<UL>
<LI><A HREF="Input.jsp?method=13&methodName=helloName" TARGET="inputs">helloName(java.lang.String)</A></LI>
</UL>
<%
if (com.ibm.ccl.ws.jaxws.gstc.util.AsyncUtils.hasAsync(sampleHelloWorld2PortProxyid.getClass())) {
%>
