...
<UL>
<LI><A HREF="Input.jsp?method=2&methodName=sum" TARGET="inputs">sum(int,int)</A></LI>
<LI><A HREF="Input.jsp?method=9&methodName=multiply" TARGET="inputs">multiply(int,int)</A></LI>
</UL>
<%
if (com.ibm.ccl.ws.jaxws.gstc.util.AsyncUtils.hasAsync(calculatorTestid.getClass())) {
%>
