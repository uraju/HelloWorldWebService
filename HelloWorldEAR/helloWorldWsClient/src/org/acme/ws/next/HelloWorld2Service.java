...
@WebServiceClient(name = "HelloWorld2Service", targetNamespace = "http://next.ws.acme.org/", wsdlLocation = "META-INF/wsdl/HelloWorld2Service.wsdl")
    ...
    extends Service
{
    ...
    static {
        HELLOWORLD2SERVICE_WSDL_LOCATION = org.acme.ws.next.HelloWorld2Service.class.getClassLoader().getResource("META-INF/wsdl/HelloWorld2Service.wsdl");
        WebServiceException e = null;
        if (HELLOWORLD2SERVICE_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'META-INF/wsdl/HelloWorld2Service.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
