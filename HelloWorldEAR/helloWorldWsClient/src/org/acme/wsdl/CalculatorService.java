...
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://acme.org/wsdl", wsdlLocation = "META-INF/wsdl/CalculatorService.wsdl")
    ...
    extends Service
{
    ...
    static {
        CALCULATORSERVICE_WSDL_LOCATION = org.acme.wsdl.CalculatorService.class.getClassLoader().getResource("META-INF/wsdl/CalculatorService.wsdl");
        WebServiceException e = null;
        if (CALCULATORSERVICE_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'META-INF/wsdl/CalculatorService.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
