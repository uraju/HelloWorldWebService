...
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://acme.org/wsdl", wsdlLocation = "META-INF/wsdl/HelloWorldService.wsdl")
    ...
    extends Service
{
    ...
    static {
        HELLOWORLDSERVICE_WSDL_LOCATION = org.acme.wsdl.HelloWorldService.class.getClassLoader().getResource("META-INF/wsdl/HelloWorldService.wsdl");
        WebServiceException e = null;
        if (HELLOWORLDSERVICE_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'META-INF/wsdl/HelloWorldService.wsdl' wsdl. Place the resource correctly in the classpath.");
        }
